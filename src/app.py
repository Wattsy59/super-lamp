...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["nate@mergington.edu", "julia@mergington.edu"]
    },
    "Basketball Practice": {
        "description": "Develop basketball skills and play in seasonal games",
    ...
    "Art Club": {
        ...
        "max_participants": 15,
        "participants": ["zoe@mergington.edu", "michelle@mergington.edu"]
    },
    "Drama Workshop": {
        "description": "Practice acting, improv, and stage production techniques",
    ...
    "Debate Society": {
        "description": "Practice debate skills and participate in academic tournaments",
